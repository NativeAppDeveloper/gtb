        ...
        <>
            {
                isSubmitted && (
                    ...
                    <div className="min-h-screen flex flex-col items-center justify-center px-6 overflow-y-auto bg-cover bg-no-repeat max-w-md mx-auto " style={{ background: `url(/overlay.png)`, backgroundRepeat: "no-repeat", backgroundSize: "cover" }}>
                        <div className="">
                            <div className="w-full px-[24px] ">
                                <div className="rounded-[20px] bg-[#F9D4AC] p-[30px] flex flex-col items-center border border-[#FFFFFFCC]">
                                    {/* Checkmark Icon */}
                                    ...
                                    <div className="mb-[15px]">
                                        <p className="text-[#2E3191] urbanist font-semibold text-[22px] leading-[30px]">
                                    ...
                                    {/* Success Message */}
                                    <p className="text-[#2E3191] urbanist font-semibold text-[20px] leading-[26px] text-center">
                    ...
                    <>
                        <div className="max-w-md  mx-auto bg-no-repeat bg-cover min-h-screen flex flex-col" style={{ backgroundImage: 'url(/login.png)' }}>
                            ...
                            <div className="flex  justify-center flex-col items-center text-center ">
                                ...
                                <div className="mt-[14px] px-[24px] leading-[24px]">
                                ...
                                <form onSubmit={handleSubmit} className="w-full px-[24px] mt-[34px] text-justify">
                                    ...
                                    <div className="mt-[18px]">
                                        ...
                                        <textarea
                                            ...
                                            placeholder="Enter"
                                            className="w-full h-[106px] rounded-[11px] bg-white px-[19px] pt-[13px] text-[20px] Urbanist text-[#000000] placeholder-[#B9B8C1] urbanist outline-none"
                                        />
                                    </div>
                                    <button
                                        type="submit"
...
export default PredgeServaScreen